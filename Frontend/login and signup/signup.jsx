...
export default function Signup() {
  ...
  const bulbStyle = {
    background: bulbOn ? lampColor : "#555",
    boxShadow: bulbOn
      ? `0 0 30px ${lampColor}, 0 0 70px ${lampColor}, 0 0 150px ${lampColor}, 0 0 300px ${lampColor}`
      : "none",
  };
  const lightStyle = {
    background: bulbOn
  ...
  return (
    <div className="login-page" data-on={bulbOn}>
      ...
      <div className="pageGlow" style={pageGlowStyle} />
