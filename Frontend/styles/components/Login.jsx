...
export default function Login() {
  ...
  return (
    <div className="login-page" data-on={isOn}>
      ...
      <div className="light" style={{ background: isOn ? `radial-gradient(circle, ${lampColor}, transparent 70%)` : "transparent", opacity: isOn ? 0.6 : 0 }} />
        ...
        <div className={`login-form ${isOn ? "active" : ""}`}>
          ...
          <form onSubmit={handleLogin} autoComplete="off">
            ...
            <div className="form-group">
              ...
              <input id="login-email" name="login-email" type="email" autoComplete="off" placeholder="Enter email" value={email} onChange={(e) => setEmail(e.target.value)} required />
            </div>
            <div className="form-group">
              <label htmlFor="login-password">Password</label>
              <input id="login-password" name="login-password" type="password" autoComplete="off" placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} required />
            </div>
